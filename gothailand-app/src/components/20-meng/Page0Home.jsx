    ...
    <div className="min-h-screen bg-[#faf8f5] text-stone-800 flex flex-col selection:bg-amber-200">
      ...
      <section className="relative w-full min-h-[580px] sm:min-h-[640px] lg:min-h-[720px] bg-sky-900 overflow-hidden flex flex-col justify-between">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/images/hero-beach.jpg')`,   // เปลี่ยน HeroSection
          }}
        >
 ...
 {/* ซ้าย: แผนที่ประเทศไทย */}
          ...
          <div className="lg:col-span-5 flex flex-col items-start">
            ...
            <div className="bg-black/35 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-white/20 shadow-2xl max-w-xs sm:max-w-sm">
              ...
              {/* กล่องแสดงแผนที่ (นำ p-3 ออก เพื่อให้ภาพชิดขอบได้) */}

               <div className="relative w-full h-48 sm:h-52 bg-gradient-to-b from-sky-950/60 to-emerald-950/60 rounded-xl flex items-center justify-center border border-white/15 overflow-hidden">

                   {/* ----- Left column: Thailand map by region ----- */}

                  {/* กำหนด w-full h-full ให้กล่องที่ครอบภาพ */}

                  <div id="destinations" className="flex scroll-mt-24 w-full h-full flex-col items-center">
...
{/*                 <div className="absolute right-2 top-2 text-[9px] text-white font-mono bg-black/40 px-2 py-1 rounded">
          ...
          {/* โลโก้วงกลมกลางหน้าจอ (ใช้ absolute จัดกึ่งกลาง) */}
          <div className="flex flex-col items-center justify-center text-center lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 z-0 pointer-events-none">
            ...
            <div className="pointer-events-auto">
              ...
              />
              {/* ข้อความซ่อนสำหรับ Screen Readers / SEO */}
...
*/}
 ...
 {/*              <span className="font-serif-luxury text-2xl sm:text-3xl font-bold tracking-tight text-[#0b1a30] mt-2">
                Go<span className="text-[#c99726]">Thailand-1</span>
              </span> */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch">
          ...
          >
            ...
            <div className="p-4 sm:p-5 flex-1 flex flex-col">
              <div className="relative h-56 sm:h-64 w-full rounded-xl overflow-hidden bg-stone-100 shadow-inner">
                <img
                  src="./public/images/service-accommodation.jpg"
          ...
          >
            ...
            <div className="p-4 sm:p-5 flex-1 flex flex-col">
              <div className="relative h-56 sm:h-64 w-full rounded-xl overflow-hidden bg-stone-100 shadow-inner">
                <img
                  src="./public/images/service-car-rental.jpg"
          ...
          >
            ...
            <div className="p-4 sm:p-5 flex-1 flex flex-col">
              <div className="relative h-56 sm:h-64 w-full rounded-xl overflow-hidden bg-stone-100 shadow-inner">
                <img
                  src="./public/images/service-tourist-guide.jpg"
